        ...
        <>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-2">
                    <button
                          ...
                          className="text-xs px-3 py-1 bg-brand-100 text-brand-700 rounded-md hover:bg-brand-200 transition-colors font-medium"
                        >
                      Select All
                    </button>
                    <button
                      ...
                      >
                        <div className="flex items-center gap-3 flex-1">
                          ...
                          <div className="flex items-center gap-2">
                            <svg
                              className={`w-4 h-4 ${selectedFlags[flag] ? 'text-brand-500' : 'text-red-600'}`}
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path
                            ...
                            <span className={`text-sm font-medium ${selectedFlags[flag] ? 'text-brand-800' : 'text-gray-700'}`}>
                              {flag.replace("FLAG_", "").replace(/_/g, " ")}
                            </span>
                          </div>
                        </div>
                        <span className={`text-sm font-bold ${selectedFlags[flag] ? 'text-brand-500' : 'text-red-600'}`}>
          ...
          <div>
            <button
              ...
              className="w-full px-6 py-4 bg-brand-500 hover:bg-brand-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
            >
              {isProcessing ? (
                <>
                  <svg
